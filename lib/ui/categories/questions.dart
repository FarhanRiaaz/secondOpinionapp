...
class _QuestionsScreenState extends State<QuestionsScreen> {
  ...
  initialize() async {
    await _categoryStore.getFormByCategory(widget.category.id!).then((value) {
      submitRequest.form = _categoryStore.categoryInstanceResponse!.id;
    });
    questionList = _categoryStore.categoryInstanceResponse?.questions ?? [];
    ...
    print(submitRequest.answers!.length);
  }
                  ...
                  child: !_categoryStore.isCategoriesInstanceInProcess
                      ? Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: MediaQuery.of(context).size.height * 0.78, child: _buildBody()),
                            SizedBox(
                              height: 7,
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      print((itemCount / 3).ceil());
                                      print(currentPage);
                                      if (currentPage + 1 < (itemCount / 3).ceil()) {
                                        print('sadsa');
                                        currentPage++;
                                        ...
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>SecondOpinionScreen(opinionSubmitRequest: submitRequest,)),  );
                                      }
                                    },
                                    child: Text('Next'),
                                  ),
...
class _UploadWidgetProfileSetupState extends State<UploadWidgetProfileSetup> with AutomaticKeepAliveClientMixin {
